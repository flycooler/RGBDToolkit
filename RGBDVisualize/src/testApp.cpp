...
void testApp::loadShaders(){
	...
	dynamicLuminosityShader.setUniform1i("tex",0);
...
void testApp::updateRenderer(ofVideoPlayer& fromPlayer){
	...
	renderer.luminosityEffect = timeline.getKeyframeValue("Luminosity Effect");
	renderer.time=(float)timeline.getCurrentFrame()*timeline.getKeyframeValue("Luminosity Time Scale");
	renderer.rangescale = timeline.getKeyframeValue("Luminosity Perlin Range");
	renderer.perlinAmount = timeline.getKeyframeValue("Luminosity Perlin Amount");
	renderer.sinePeriod = timeline.getKeyframeValue("Luminosity Sine Period");
	renderer.sineAmount = timeline.getKeyframeValue("Luminosity Sine Amount");
